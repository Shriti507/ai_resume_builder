...
const Footer = () => {
    ...
    return (
        ...
        <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#5f3103] to-[#9d6005] text-white/70">
            <h1>AI ResumeBuilder</h1> 
            <p className="mt-4 text-center">Copyright © 2025 <a href="https://prebuiltui.com">AI ResumeBuilder</a>. All rights reservered.</p>
