...
const Dashboard = () => {
  ...
  const editTitle = async (event) => {
    event.preventDefault();
    // Update the resume title logic here
          ...
          >
            ...
            >
              ...
              <input
                ...
                required
              />
              <button className="w-full py-2 bg-[#b67d0d] text-white rounded  hover:bg-[#b79453] transition-colors">
                Create Resume
              </button>
              <XIcon
        ...
        {showUploadResume && (
          ...
          >
            ...
            >
              ...
              <button className="w-full py-2 bg-[#742b09f7] text-white rounded  hover:bg-[#503326f7] transition-colors">
                Upload Resume
              </button>
              <XIcon
                className="absolute top-4 right-4 text-slate-400  hover:text-slate-600 cursor-pointer transition-colors"
